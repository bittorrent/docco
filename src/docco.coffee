...
parse = (source, code) ->
  ...
  save = (ui-docs, code) ->
    sections.push docs_text: ui-docs, code_text: code
...
destination = (filepath) ->
  'ui-docs/' + path.basename(filepath, path.extname(filepath)) + '.html'
...
if sources.length
  ensure_directory 'ui-docs', ->
    fs.writeFile 'ui-docs/docco.css', docco_styles
